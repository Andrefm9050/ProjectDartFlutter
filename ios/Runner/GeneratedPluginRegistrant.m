...
#if __has_include(<md5_file_checksum/Md5FileChecksumPlugin.h>)
#import <md5_file_checksum/Md5FileChecksumPlugin.h>
#else
@import md5_file_checksum;
#endif
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [Md5FileChecksumPlugin registerWithRegistrar:[registry registrarForPlugin:@"Md5FileChecksumPlugin"]];
